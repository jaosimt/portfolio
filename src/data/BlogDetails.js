...
export const kadauganDetails = <Fragment>
    ...
    <p>Kadaugan sa Mactan (Victory in Mactan) is a celebration reenacting the victory of Mactan people
...
export const boholHymnDetails = <Fragment>
    ...
    <div className="bohol-hym-lyrics">
        ...
        <p>
            <span>Bahandi ang dagat ug kapatagan</span><br/>
            <strong className="bybyn">ᜊᜑᜈ᜔ᜇᜒ ᜀᜅ᜔ ᜇᜄᜆ᜔ ᜂᜄ᜔ ᜃᜉᜆᜄᜈ᜔</strong>
        </p>
        <p>
    ...
    <br/>
    <audio style={{ marginTop: '1.5em' }} controls>
...
export const lusonensisDetails = <Fragment>
    ...
    <span>According to <a href="//en.wikipedia.org/wiki/Homo_luzonensis" target="_blank"
...
export const baybayinKeyboardDetails = <Fragment>
    ...
    <p><strong>How to correctly use this baybayin keyboard?</strong><br/>First, always remember its default, which is a
        pair of <strong>one consonant</strong> (or two for nga)
    ...
    <p>The same is true when you are typing a word that starts with a vowel! For
        example: <strong>aklat(<i>book</i>)</strong>, <strong>ilog(<i>river</i>)</strong> and <strong>ulo(<i>head</i>)</strong> amongst
        others.</p>
    ...
    <p>That’s it! Once you keep all that in mind? You will be typing baybayin in this keyboard like you’re doing it with
        latin/roman
        scripts.</p>
    ...
    <ol>
        ...
        <ul>
            ...
            <li>Filipino languages and dialects are originally using <a href="//en.wikipedia.org/wiki/Abakada_alphabet"
                                                                        target="_blank" rel="noreferrer">Abakada
                alphabet</a>!
            </li>
            <li>And since the Abakada alphabet has I (pronounced with a long "ee" sound as in me or she), E (pronounced
                with a short "e" sound as in bed or set) and O (pronounced with a short "o" sound as in so or tow), U
                (pronounced with a long "oo" sound as in foot or took) which are absent (or interchangeable) in the
                scripts, I think it's safe to say that the alphabet are derived and updated from Baybayin!
            </li>
        </ul>
    </ol>

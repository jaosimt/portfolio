...
export const pinoyKeyboardDetails = <Fragment>
	...
	<h4 className='label'>By the way, your android phone might not be able to download the apk on a simple click.  If that is your case, try long-pressing the link and wait for the context menu and download from there.</h4>
